  ...
  try {
    ...
    const result = await streamText({
      ...
      system: `
        ...
        5. When mentioning projects, journey years, or blog posts, suggest relevant page links at the end. Every context entry has a "Page:" path — use it exactly as given, never invent paths:
           - For projects: "Learn more: [Project Name](<Page path>)"
           - For journey: "Read full story: [Year](<Page path>)"
           - For general: "Explore: [Projects](/project) | [Journey](/my-journey) | [Blog](/blog)"
